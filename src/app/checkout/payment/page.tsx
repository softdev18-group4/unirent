    ...
    <div>
      <div className="px-[5%]">
        ...
        <div className="flex flex-col space-y-5 lg:min-h-max">
          <div className="lg:w-2/3 lg:pr-[5%]">
            <div
              ...
              className="bg-white w-full h-28 rounded-2xl"
              style={{
            ...
            >
              <div className="flex justify-between px-4 h-full">
                ...
                <div
                  ...
                  style={{ display: `${paymentMethod == 1 ? "" : "none"}` }}
                >
                  <svg
                    fill="#FF6E31"
                    viewBox="0 0 200 200"
          ...
          <div className="lg:w-2/3 lg:pr-[5%]">
            ...
            >
              <div className="flex justify-between px-4 h-full">
                ...
                <div
                  className="w-12  flex justify-center"
                  style={{ display: `${paymentMethod == 2 ? "" : "none"}` }}
                >
                  <svg
                    fill="#FF6E31"
                    viewBox="0 0 200 200"
          ...
          <div className="lg:w-2/3 lg:pr-[5%]">
            ...
            >
              <div className="flex justify-between px-4 h-full">
                ...
                <div
                  className="w-12  flex justify-center"
                  style={{ display: `${paymentMethod == 3 ? "" : "none"}` }}
                >
                  <svg
                    fill="#FF6E31"
                    viewBox="0 0 200 200"
        ...
        <div className="sticky pb-8 bottom-0 h-24 z-40 bg-[#f1f6f9] lg:w-2/3 lg:pr-[5%] flex justify-between items-end ">
          <Link href="/checkout/contract" className="font-bold text-slate-400">
            &lt; Return To Cart
          </Link>
          <Link
            onClick={toggleModal}
