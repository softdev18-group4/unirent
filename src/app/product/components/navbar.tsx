  ...
  return (
    <div className="px-[5%] sticky top-0 z-50 bg-[#f1f6f9]">
      <nav className="flex justify-between items-center py-4">
        <div className="cursor-default flex grow-[1] text-center uppercase pr-3 py-3 font-extrabold text-3xl">
          <div className="theme-text-color2">uni</div>
          <div className="theme-text-color1">rent</div>
        </div>

        <div className="grow-[3] hidden md:flex items-center justify-evenly theme-bg-color1 rounded-full font-medium px-3 py-2">
          {[
        ...
        <div className="grow-[1] hidden md:flex items-center pl-3 py-3 font-medium justify-end ">
          {/* computer icon */}
          <svg
        ...
        <div className="block md:hidden">
          <div className="w-full py-6 pb-8">
            <div className="relative inline-block">
              ...
              {isOpen && (
                <div className="origin-top-right absolute right-0 mt-2 w-44 rounded-lg shadow-lg theme-bg-color1 ring-1 ring-black ring-opacity-5">
                  <ul
                    role="menu"
