    ...
    <div className="product_characteristics">
      ...
      {product && (
        <div>
          ...
          <CardDetail
            detail={`graphicCard : ${product.specifications.graphicCard}`}
          />
          <CardDetail detail={`model : ${product.specifications.model}`} />
          <CardDetail
            detail={`processor : ${product.specifications.processor}`}
          />
          <CardDetail detail={`ramSize :${product.specifications.ramSize}`} />
          <CardDetail
            detail={`storageSize :${product.specifications.storageSize}`}
          />
        </div>
      )}
    </div>
