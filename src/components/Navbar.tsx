      ...
      <nav>
        ...
        <div className="hidden md:flex justify-between items-center py-4">
          ...
          <div className="grow-[1] flex items-center pl-3 py-3 font-medium justify-end ">
            <div onClick={() => push("/checkout/cart")} className="relative">
              <svg
            ...
            {session ? (
              ...
              <button
                ...
                className="uppercase text-xl px-8 ml-1 py-2 bg-[color:var(--theme-color2)] hover:bg-[color:var(--theme-color1)] text-white rounded-full transition-all duration-300 ease-in-out"
              >
                sign in
              </button>
            )}
